...
import { parseFudomo, loadModel, transform, generateSkeletonModule, MetamodelInferer, TransformationValidator, DataValidator } from 'fudomo-transform' // TODO use ES6 modules
  ...
  async validateData() {
    ...
    for (const configPath of paths) {
      try {
        ...
        const model = loadModel(dataFile.getPath());
